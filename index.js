...
/////////////////
const BotName = 'CHIKAA BOT🐼'; 
const instagram = 'https://instagram.com/icce_welder'; 
const telegram = 'https://t.me/chikaa'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/chik';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@icce_welder')
